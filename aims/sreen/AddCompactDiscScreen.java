...
import lab_02.CompactDisc;
import lab_02.Track;
import lab_02.Aims;

public class AddCompactDiscScreen extends AddItemScreen {
	...
	private class AddTracksToCompactDiscScreen extends AddItemScreen {
				...
				case "OK": {
					...
					try {
						...
						if (screenIndex == numberTracks) {
							...
							AddCompactDiscScreen.this.setVisible(false);
